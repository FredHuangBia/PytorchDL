...
class myModel(nn.Module):
	def __init__(self, opt):
		...
		self.conv5 = nn.Conv2d(in_channels=256, out_channels=512, kernel_size=(1,3), stride=(1,1), padding=(0,1))
		self.bn5 = nn.BatchNorm2d(512)
		self.conv6 = nn.Conv2d(in_channels=512, out_channels=512, kernel_size=(1,3), stride=(1,1), padding=(0,1))
		self.bn6 = nn.BatchNorm2d(512)
		self.fc1 = nn.Linear(384*4, 4)
